            ...
            try
            {
                if ((line = br.readLine()) != null) {
                   ...
                   if (m.find()) {
                    ...
                    if (playLoopAtEnd) startPlaybackOfFile();
                }
            } catch (Exception e)
            {
    ...
    private void generateFrame()
    {
        ...
        switch (fType)
        {
            ...
            case 2: // This one has data where the value changes between 3 different values
                ...
                f.setDlc(8);
                switch (fLast) {
                    default: data = new int[] {33, 128, 32, 132, 232, 222, 102, 0}; break;
                    case 1: data = new int[] {33, 30, 50, 132, 232, 30, 102, 0}; break;
                    case 2: data = new int[] {33, 50, 70, 132, 232, 60, 102, 0}; break;
                }
